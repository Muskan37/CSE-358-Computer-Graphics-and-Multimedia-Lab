...
PFNGLSHADERSTORAGEballBINDINGPROC glad_glShaderStorageballBinding;
...
PFNGLGETACTIVEUNIFORMballIVPROC glad_glGetActiveUniformballiv;
...
PFNGLUNIFORMballBINDINGPROC glad_glUniformballBinding;
...
PFNGLGETACTIVEUNIFORMballNAMEPROC glad_glGetActiveUniformballName;
...
PFNGLGETUNIFORMballINDEXPROC glad_glGetUniformballIndex;
...
int GLAD_GL_EXT_shader_io_balls;
...
int GLAD_GL_OES_shader_io_balls;
...
static void load_GL_VERSION_3_1(GLADloadproc load) {
	...
	glad_glGetUniformballIndex = (PFNGLGETUNIFORMballINDEXPROC)load("glGetUniformballIndex");
	glad_glGetActiveUniformballiv = (PFNGLGETACTIVEUNIFORMballIVPROC)load("glGetActiveUniformballiv");
	glad_glGetActiveUniformballName = (PFNGLGETACTIVEUNIFORMballNAMEPROC)load("glGetActiveUniformballName");
	glad_glUniformballBinding = (PFNGLUNIFORMballBINDINGPROC)load("glUniformballBinding");
	glad_glBindBufferRange = (PFNGLBINDBUFFERRANGEPROC)load("glBindBufferRange");
	glad_glBindBufferBase = (PFNGLBINDBUFFERBASEPROC)load("glBindBufferBase");
	glad_glGetIntegeri_v = (PFNGLGETINTEGERI_VPROC)load("glGetIntegeri_v");
}
...
static void load_GL_VERSION_4_3(GLADloadproc load) {
	...
	glad_glShaderStorageballBinding = (PFNGLSHADERSTORAGEballBINDINGPROC)load("glShaderStorageballBinding");
...
static void find_extensionsGLES2(void) {
	...
	GLAD_GL_OES_shader_io_balls = has_ext("GL_OES_shader_io_balls");
	...
	GLAD_GL_NV_fragment_shader_interlock = has_ext("GL_NV_fragment_shader_interlock");
	GLAD_GL_EXT_separate_shader_objects = has_ext("GL_EXT_separate_shader_objects");
	GLAD_GL_EXT_shader_io_balls = has_ext("GL_EXT_shader_io_balls");
